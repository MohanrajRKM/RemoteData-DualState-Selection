import{j as e}from"./index-C6j-OS9u.js";import{C as r,a as o,m as te,b as ae,D as G,P as re,G as oe,c as ie,d as le,S as B,Q as se,e as _,f as de,W as ue,g as Q,h as t,U as ce,i as pe,T as A,j as me}from"./data-DZsVy9nZ.js";import{r as i}from"./index-CtNveh2g.js";import"./index-LwkqeIug.js";const he=[40,80,120,200],v=a=>{var x,D,R,E,T;const{enableRtl:g,enableRipple:J,localDataCount:l,isTextWrapData:S,isDialogInsideGrid:C,isStrictMode:K,isMultipleChildren:X,parentContainerHeight:$="93vh",...n}=a;((R=(D=n.columns)==null?void 0:D[((x=n.columns)==null?void 0:x.length)-1])==null?void 0:R.headerText)==="Command Actions"&&(n.columns[((E=n.columns)==null?void 0:E.length)-1].getCommandItems=()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]);const b=i.useRef(null),f=i.useRef(null),[w,Y]=i.useState(!0),[y,Z]=i.useState(!1),ee=i.useMemo(()=>S?te(l):ae(l,n.columns),[l,(T=n.columns)==null?void 0:T.length]),s=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>Z(!y),children:[y?"Destroy":"Render"," Data Grid"]}),l&&!S&&e.jsxs("button",{onClick:()=>Y(!w),children:[w?"Uniform":"Non Uniform"," Row Height Applied"]}),y&&e.jsx(re,{dir:g?"rtl":"ltr",ripple:J,locale:n.locale,children:e.jsx(oe,{ref:b,dataSource:l?ee:[],...n,columns:n.children?void 0:n.columns,aggregates:n.children?void 0:n.aggregates,getRowHeight:w?null:ne=>he[ne.rowIndex%4],children:X?n.children.props.children:n.children})}),e.jsx("button",{onClick:()=>{console.log(b)},children:"dummy navigation checking button with get GridRef"})]});return e.jsx("div",{ref:f,style:{height:$},children:K?e.jsx(i.StrictMode,{children:C?e.jsx(G,{open:!0,fullScreen:!0,target:f.current,children:s()}):s()}):C?e.jsx(G,{open:!0,fullScreen:!0,target:f.current,children:s()}):s()})};try{v.displayName="LargeDataGridTest",v.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
};`,name:"rowClass",required:!1,type:{name:"string | ((props?: RowClassProps<unknown>) => string)"}},loadingIndicatorType:{defaultValue:{value:"LoadingIndicatorType.Spinner"},description:`Configures the loading indicator for the Grid component.
Determines the visual representation of the loading state.`,name:"loadingIndicatorType",required:!1,type:{name:"enum",value:[{value:'"Spinner"'},{value:'"Shimmer"'}]}},onGridRenderStart:{defaultValue:null,description:`Fires at the start of grid initialization before data processing.
...
\`\`\``,name:"onDataChangeCancel",required:!1,type:{name:"(event: FormCancelEvent<unknown>) => void"}}}}}catch{}const Ce={title:"Grid/VirtualGridBase",component:v,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["0","100","1000","10000","100000"],description:"Grid Local DataSource Count"}}},h=le(100,!1),ge=[{columns:ie(h.length)}];h.unshift({type:me.Checkbox,width:50,allowFilter:!1});h.push({headerText:"Command Actions",width:200,getCommandItems:()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]});const d={args:{localDataCount:1e5,columns:h,aggregates:ge,editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:1e5},height:"100%"}},u={args:{dataSource:new _({url:"https://ej2services.syncfusion.com/react/hotfix/api/UrlDataSource",adaptor:new ce}),query:new se().addParams("dataCount","100000"),toolbar:["Search"],children:e.jsxs(Q,{children:[e.jsx(t,{field:"EmployeeID",visible:!1,headerText:"Employee ID",isPrimaryKey:!0,width:"130"}),e.jsx(t,{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"}),e.jsx(t,{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"}),e.jsx(t,{field:"Mail",headerText:"Mail",width:"230"}),e.jsx(t,{field:"Location",headerText:"Location",width:"140"}),e.jsx(t,{field:"Status",headerText:"Status",width:"130"}),e.jsx(t,{field:"Trustworthiness",headerText:"Trustworthiness",width:"160"}),e.jsx(t,{field:"Rating",headerText:"Rating",width:"220"}),e.jsx(t,{field:"Software",headerText:"Software Proficiency",width:"180",format:"C2"}),e.jsx(t,{field:"CurrentSalary",headerText:"Current Salary",width:"160",format:"C2"}),e.jsx(t,{field:"Address",headerText:"Address",width:"240",clipMode:"EllipsisWithTooltip"})]}),selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{enableCache:!1,scrollMode:B.Virtual},height:"100%"}},c={args:{dataSource:new _({url:"https://ej2services.syncfusion.com/react/hotfix/api/GridWebAPIService",adaptor:new pe}),columns:[{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130",allowSearch:!1},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1}],selectionSettings:{mode:"Single"},sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{scrollMode:B.Virtual},height:"100%"}},p={args:{dataSource:de,children:e.jsxs(Q,{children:[e.jsx(t,{headerText:"Employee Image",width:"180",textAlign:A.Center,field:"EmployeeID"}),e.jsx(t,{headerText:"Employee Details",width:"300",textAlign:A.Left,field:"FirstName"})]}),className:"row-template",toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},height:"100%",rowTemplate:a=>{const g=`https://npmci-react.syncfusion.com/development-react-ui/images/grid/${a.EmployeeID}.png`;return e.jsxs("tr",{className:"templateRow",children:[e.jsx("td",{className:"photo",children:e.jsx("img",{src:g,alt:a.EmployeeID.toString()})}),e.jsx("td",{className:"details",children:e.jsxs("table",{className:"CardTable",cellPadding:3,cellSpacing:2,children:[e.jsxs("colgroup",{children:[e.jsx("col",{style:{width:"30%"}}),e.jsx("col",{style:{width:"10%"}})]}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"First Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.FirstName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Last Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.LastName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Title"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.Title})]})]})]})})]})}}},fe=[{field:"id"},{field:"username",width:150},{field:"age",width:80,type:"number"},{field:"bio",width:400}],m={args:{localDataCount:1e5,isTextWrapData:!0,columns:fe,height:400,textWrapSettings:{enabled:!0,wrapMode:ue.Both}}};var q,F,k;d.parameters={...d.parameters,docs:{...(q=d.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
...
}`,...(k=(F=d.parameters)==null?void 0:F.docs)==null?void 0:k.source}}};var V,j,I;u.parameters={...u.parameters,docs:{...(V=u.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
...
}`,...(I=(j=u.parameters)==null?void 0:j.docs)==null?void 0:I.source}}};var M,z,P;c.parameters={...c.parameters,docs:{...(M=c.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(P=(z=c.parameters)==null?void 0:z.docs)==null?void 0:P.source}}};var W,N,L;p.parameters={...p.parameters,docs:{...(W=p.parameters)==null?void 0:W.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
...
}`,...(L=(N=p.parameters)==null?void 0:N.docs)==null?void 0:L.source}}};var U,H,O;m.parameters={...m.parameters,docs:{...(U=m.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    localDataCount: 100000,
    isTextWrapData: true,
    columns: muicolumns,
...
}`,...(O=(H=m.parameters)==null?void 0:H.docs)==null?void 0:O.source}}};const be=["LocalData","UrlAdaptorData","WebApiAdaptorData","RowTemplate","TextWrapSample"];export{d as LocalData,p as RowTemplate,m as TextWrapSample,u as UrlAdaptorData,c as WebApiAdaptorData,be as __namedExportsOrder,Ce as default};
